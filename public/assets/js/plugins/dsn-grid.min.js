!(function (t) {
                    ...
                    jQuery(
                        ...
                        t.then(() => {
                            i.data("dsn-animation") && Object(d.default)(i),
                                i.hasClass("use-horizontal-scroll") &&
                                    Object(l.default)(i),
                                i.hasClass("use-horizontal-scroll-image") &&
                                    Object(p.default)(i),
                                i.hasClass("dsn-animate-video") &&
                                    Object(m.default)(i),
                                i.hasClass("pinned-scroll") &&
                                    Object(v.default)(i);
                        });
                    }),
                        t
    ...
    function (t, e, n) {
        ...
        const r = (t, e = !0) => {
            ...
            a = (t, e = null) => {
                if (t)
                    return Splitting({ target: t, by: "items", matching: e });
            },
            c = (t, e = null) => {
                ...
                t.html(
                    ...
                    t.find("[data-dsn-number]").each(function () {
                        gsap.effects.animateNumber(this, {
                            textContent:
                                Object(i.dataAttr)(this, "number") || 0,
                            onComplete: function () {
            ...
            t &&
                (t.forEach((t) =>
                    gsap.set(t, {
                        strokeDashoffset:
                            100 -
                            Number.parseInt(Object(i.dataAttr)(t, "progress")),
                    })
                ),
                gsap.from(t, 1.5, {
                    ...
                    onUpdate: function () {
                        this._targets.forEach(function (t) {
                            t
                                ...
                                100 -
                                t.style.strokeDashoffset.match(/\d+/)[0] +
                                "%";
                        });
                    },
                    onComplete: function () {
                ...
                t.each(function () {
                    ...
                    const { speed: t = 0, start: e = 0 } =
                        ...
                        o = this.querySelector(
                            ".start-section .dsn-animate-up"
                        ),
                        s = this.querySelector(
                            ".start-section .dsn-animate-down"
                        ),
                        a = this.querySelector(".end-section .dsn-animate-up"),
                        c = this.querySelector(
                            ".end-section .dsn-animate-down"
                        ),
                    ...
                    n.to(this, {
                        ...
                        c &&
                            d.from(a, { y: -150, opacity: 0, ease: "none" }, 0),
                        Object(r.killAjax)(function () {
        ...
        e.default = function (t = jQuery(document)) {
            t.each(function () {
                ...
                const E = {
                    trigger:
                        y ||
                        (p ? jQuery(this).parents(".elementor-section") : this),
                    invalidateOnRefresh: !0,
                    scrub: g,
                    anticipatePin: 1,
                    pin: p,
                    ...
                    start: "top " + m,
                        ...
                        (null == v
                            ? void 0
                            : v.replace("{{height}}", this.offsetHeight)),
                };
                Object(r.default)((t) => {
                    const {
                            isDesktop: n,
        ...
        n.r(e),
            (e.default = function (t, e = {}) {
                ...
                if (
                    ...
                    return;
                const o =
                    (e = Object.assign({ offset: -100 }, e)).offset || -100;
                delete e.offset,
                    gsap.to(
                        (null === (n = window) ||
                        void 0 === n ||
            ...
            const e = jQuery,
                n = Object.assign(
                    {},
                    {
                        trigger: "#main_root",
                        prevent:
                            'a.effect-ajax , #dsn-primary-list a:not([href*="#"])',
                        mainRoot() {
                                ...
                                return (
                                    (l.start = (async function () {
                                        const e = {
                                            ...
                                            current: n.mainRoot(),
                                            next: null,
                                            text: Object(s.dataAttr)(
                                                l.trigger,
                                                "text"
                                            ),
                                        };
                                        "function" ===
                                            (await typeof t.beforeSend) &&
                            ...
                            success: function (e) {
                                l.start
                                    .then(async () => {
                                        ...
                                        "function" ===
                                            (await typeof t.beforeSuccess) &&
                                            (await t.beforeSuccess(i)),
                                            window.dispatchEvent(
                                                new CustomEvent(
                                                    "dsn/ajax/beforeSuccess",
                                                    { bubbles: !0, detail: i }
                                                )
                                            ),
                                            "popstate" !== a.type &&
                                            ...
                                            "function" ===
                                                (await typeof t.afterSuccess) &&
                                                t.afterSuccess(i),
                                            window.dispatchEvent(
                                                new CustomEvent(
                                                    "dsn/ajax/afterSuccess",
                                                    { bubbles: !0, detail: i }
                                                )
                                            );
                                    })
        ...
        e.default = function (t) {
            const e = t.trigger.parents(".slide-content"),
                ...
                r = e
                    .parents(".main-slider")
                    .find(
                        '.bg-container .swiper-slide[data-dsn-id="' +
                            n +
                            '"] .cover-bg'
                    )
                    .first(),
        ...
        function r(t, e, n, r, o = {}) {
            ...
            return (
                ...
                (c || c.length) &&
                    ...
                    c.find("[data-word]").length ||
                        dsnGrid.spltting.Char(c.get(0))),
                void 0 !== o.before &&
                    o.before({ container: s, title: c, img: a }),
                $body.append(s),
                gsap.to(s, 1, {
                    autoAlpha: 1,
                    ease: "power2.out",
                    oncomplete: function () {
                        void 0 !== o.after &&
                            o.after({ container: s, title: c, img: a });
                    },
                })
            );
        }
    ...
    function (t, e, n) {
        ...
        e.default = function (t, e) {
            return new Promise(function (n, o) {
                return (async function (t, e) {
                    return jQuery(".dsn-ajax-loader").hasClass(
                        "dsn-transition-section"
                    )
                    ...
                    .then(
                        (n) => (
                            ...
                            window.dispatchEvent(
                                new CustomEvent("dsn/ajax/complete", {
                                    bubbles: !0,
                                    detail: t,
                                })
                            ),
                    ...
                    .then((t) => n(t))
                    .catch((t) =>
                        console.error("error on completeTransition", t)
                    );
            });
        };
    },
        ...
        async function o(t) {
            ...
            return (
                ...
                await jQuery(t)
                    ...
                    .each(function () {
                        n.find('link[href="' + jQuery(this).attr("src") + '"]')
                            .length || n.append(jQuery(this));
                    }),
                await r.remove(),
        ...
        n.r(e),
            (e.default = function ({
                ...
                const r = window.performance.timing,
                    o =
                        (((-1 * (r.loadEventEnd - r.navigationStart)) / 1e3) %
                            50) *
                        10;
                let s = t,
                    a = e > t ? 1 : -1,
        ...
        const o = function (t) {
            ...
            const p = (t, e, n) => {
                    ...
                    (i.magFilter = THREE.LinearFilter),
                        ...
                        (i.dsn_video = jQuery("<img src='" + e + "' />").get(
                            0
                        )),
                        (l[n] = i);
                },
            ...
            (async () => (
                ...
                .then(() => {
                    (this.loader = new THREE.TextureLoader(this.manager)),
                        ((c = this.loader.load(n)).wrapS = c.wrapT =
